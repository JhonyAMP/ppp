                ...
                <div class="ms-3 relative">
                    <x-dropdown>
                        ...
                        <x-dropdown.header label="{{ __('Manage Account') }}">
                            <x-dropdown.item icon="user" label="{{ __('Profile') }}" href="{{ route('profile.show') }}" />
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <x-dropdown.item separator label="{{ __('Log Out') }}" href="{{ route('logout') }}" @click.prevent="$root.submit();" />
                        </form>
                    </x-dropdown>
                </div>
            </div>
